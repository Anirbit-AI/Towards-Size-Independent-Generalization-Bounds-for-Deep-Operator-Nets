...
if __name__=="__main__":
    ...
    for N_train in N_train_list:
        ...
        # Save model params
        save_checkpoint(model.params, f'./outputs/saved_models/model_N_train_{N_train}_checkpoint_{loss_type}.npz')

        # Plot train and test errors
        plot_train_test_error(model, f"train_test_error_plots_N_train_{N_train}_{loss_type}")
    ...
    size_list = np.array(N_train_list)*P_train
